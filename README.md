...
## Native Type 7
![alt text](https://github.com/ClimaxCode/adspub/blob/main/screenshots/native%207.png?raw=true)
### Add this code to XML
	    <androidx.constraintlayout.widget.ConstraintLayout
        android:layout_width="match_parent"
        android:layout_height="match_parent"
...
### Call the Native Ad
	activity.callNativeAd("Native Id","native7 ",Preload Ad (Boolean Value),Load New Ad (Boolean Value),{actionLoaded},{actionFailed},{tryToShowAgain},Pass Button Color,Pass Button Text Color, Pass Background Color)
